...
<\body>
  ...
  <\equation>
    <around*|(|R<rsup|\<alpha\>><rsub|m>|)><rsup|\<ast\>><around*|(|x,t|)>=<big|sum><rsub|n=0><rsup|N<rsub|cut>-m><frac|<around*|(|-1|)><rsup|m+n>|n!><frac|\<partial\><rsup|n>|\<partial\>x<rsup|\<beta\>>>R<rsup|\<alpha\>\<beta\>><rsub|m+n><around*|(|x,t|)>.
  </equation>
...
<\references>
  <\collection>
    ...
    <associate|eq:r-fourier|<tuple|4|7>>
